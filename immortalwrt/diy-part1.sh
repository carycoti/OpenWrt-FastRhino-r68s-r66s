...
rm -rf feeds/packages/utils/v2dat
rm -rf feeds/kiddin9/{base-files,dnsmasq,firewall*,fullconenat,libnftnl,nftables,ppp,opkg,ucl,upx,miniupnpd-iptables,wireless-regdb,quectel_SRPD_PCIE,adguardhome,shortcut-fe,fibocom_QMI_WWAN,quectel_QMI_WWAN,rtl8189es}
mv -f feeds/kiddin9/r81* tmp/

./scripts/feeds install -a -p kiddin9 -f
./scripts/feeds install -a

# ucl, vsftpd*, quectel_SRPD_PCIE, fibocom_QMI_WWAN
